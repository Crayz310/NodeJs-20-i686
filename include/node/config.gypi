...
{ 'target_defaults': {'cflags': ['-march=native'], 'default_configuration': 'Release', 'defines': ['NODE_OPENSSL_CONF_NAME=nodejs_conf', 'ICU_NO_USER_DATA_OVERRIDE'], 'include_dirs': [], 'libraries': []},
  'variables': { 'asan': 0,
                 'clang': 0,
                 'coverage': 'false',
                 'dcheck_always_on': 0,
                 ...
                 'node_prefix': '/home/undef1n3dd/.nvm/versions/node/v20.19.5',
